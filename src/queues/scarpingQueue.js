...
import { scrapeSearchResults, scrapeSearchResultsWithPlayWright } from '../services/scraper.service.js';
...
scrapingQueue.process(async (job) => {
    ...
    const results = await scrapeSearchResultsWithPlayWright(keyword);
